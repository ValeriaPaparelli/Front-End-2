const noticias = [
  {
    ...
    descripcion:
      "La cantante fue vista averiguando sobre escuelas enLos Ángeles, lo que hace suponer que podría mudarse con sus hijos allí para estar cerca del actor",
    fecha: "02/06/21",
    tipoNacional: false,
  },
  {
  ...
  },
  {
    ...
    descripcion:
      "Fácil y rápido son los dos adjetivos que más repiten las personas que describen cómo es el proceso de vacunación en elaeropuerto internacional de Miami. En su mayoría son turistasinternacionales quienes se inoculan al día en la clínica instalada en laterminal aérea",
    fecha: "07/06/21",
    tipoNacional: true,
  },
];
...
for (let i = 0; i < noticias.length; i++) {
  ...
  image.setAttribute("src", noticia.imgUrl);

  div.appendChild(image);

  const description = document.createElement("p");
  description.innerText = noticia.descripcion;
  description.classList.add("description");
  div.appendChild(description);

  const date = document.createElement("p");
  date.innerText = noticia.fecha;
